  ...
  return (
    <>
      ...
      <div className={`${styles.mobileMenu} ${mobileOpen ? styles.open : ''}`}>
        ...
        <a href="#solution" onClick={() => setMobileOpen(false)}>Solution</a>
        <a href="#features" onClick={() => setMobileOpen(false)}>Features</a>
        <a href="#who" onClick={() => setMobileOpen(false)}>Who It's For</a>
        <a href="#about" onClick={() => setMobileOpen(false)}>About</a>
        <a href="#" className={styles.mobileCtaButton} onClick={() => setMobileOpen(false)}>
          Request Demo
        </a>
      </div>
    </>
